...
(function (A, B) {
    ...
    A.fn.lazyload = function (D) {
        ...
        function F() {
            ...
            C.each(function () {
                var H = A(this);
                if (E.skip_invisible && !H.is(":visible")) {
                    return
                }
        ...
        if (0 === E.event.indexOf("scroll")) {
            $container.bind(E.event, function (G) {
                return F()
            })
        }
        this.each(function () {
            ...
            G.one("appear", function () {
                if (!this.loaded) {
                    ...
                    A("<img />").bind("load", function () {
                        G.hide().attr("src", G.data(E.data_attribute))[E.effect](E.effect_speed);
                        H.loaded = true;
                        var K = A.grep(C, function (L) {
                            return !L.loaded
                        });
                        C = A(K);
                        if (E.load) {
                    ...
                    }).attr("src", G.data(E.data_attribute))
                }
            });
            if (0 !== E.event.indexOf("scroll")) {
